...
def main():
    ...
    if training_args.do_eval:
        ...
        metrics["adjust ratio"] = model_args.adjust_ratio
        metrics["mask_threshold"] = model_args.mask_threshold
    ...
    os.rename(os.path.join(training_args.output_dir, "eval_results.json"), os.path.join(training_args.output_dir, f"eval_results_{model_args.adjust_ratio}_{model_args.mask_threshold}.json"))
    remove_hooks(handle_dict)
